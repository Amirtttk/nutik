                                    ...
                                    <table class="table table-bordered table-hover table-checkable" id="manager"
                                        ...
                                        <tbody>
                                            ...
                                            if ($getAllNotifications) {
                                                foreach ($getAllNotifications as $key => $AllNotifications) {
                                                    ?>
                                                    <tr id="deleteNotifications<?php echo $AllNotifications['id']?>">
                                                        <td><?= $keyNumber++ ?></td>
                                                        <td style="min-width:150px;"><?= $AllNotifications['title'] ?></td>
                                                        <td style="min-width:200px;"><?= $AllNotifications['description'] ?></td>
                                                        <td id="statusShow<?= $AllNotifications['id'] ?>">
                                                            <?php
                                                            if ($AllNotifications['status'] == 1) {
                                                                ?>
                                                                <span
                                                        ...
                                                        <td id="statusNotifications<?= $AllNotifications['id'] ?>">
                                                            <?php
                                                            if ($AllNotifications['status'] == 2) {
                                                                ?>
                                                                <span class="switch switch-icon">
                                                                    <label>
                                                                        <input id="changeStatusInput<?= $AllNotifications['id'] ?>"
                                                                            onclick="statusNotifications(<?= $AllNotifications['id'] ?>, 1)"
                                                                ...
                                                                <span class="switch switch-icon">
                                                                    <label>
                                                                        <input
                                                                            id="changeStatusInput<?= $AllNotifications['id'] ?>"
                                                                            onclick="statusNotifications(<?= $AllNotifications['id'] ?>, 2)"
                                                        ...
                                                        <td>
                                                            <a href="<?= url("/admin/notifications/update?id={$AllNotifications['id']}") ?>"
                                                            ...
                                                            <button type="button" onclick="delteNotifications(<?= $AllNotifications['id'] ?>)" class="btn btn-icon btn-danger btn-sm mr-2 " data-toggle = "tooltip" title = "حذف" data-theme = "dark">
