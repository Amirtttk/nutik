<?php
$getOneBanner = getInformation(GET('id'));
?>
<!--begin::Content-->
    ...
    <div class="subheader py-2 py-lg-4  subheader-solid " id="kt_subheader">
        <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Page Title-->
                <h5 class="card-label"> ویرایش  بنر صفحه مقالات</h5>
                <!--end::Page Title-->
            </div>
            <!--end::اطلاعات-->
        </div>
                ...
                <div class="card card-custom">
                    <div class="card-header">
                        <div class="card-title">
                            ...
                            <h3 class="card-label"> ویرایش  بنر صفحه مقالات</h3>
                        </div>
                                        ...
                                        <div class="card-body">
                                            <div class="form-group row">
                                                <div class="col-lg-6">
                                                    ...
                                                    <input name="link_blog" type="text" value="<?= $getOneBanner['link_blog'] ?>" class="form-control" placeholder="لینک بنر را وارد نمایید " />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-footer">
                                            <button type="button" class="btn btn-success" onclick="updateLinkBlog(<?= $_GET['id'] ?>)">ویرایش اطلاعات</button>
                                        </div>
                                    </form>
                                </div>
                                    ...
                                    <form id="myform">
                                        <div class="row p-3">
                                            <label class="upload-file py-3 w-100">
                                                ...
                                                <input onchange="updateImageBannerBlog(<?php echo $_GET['id'] ?>)"
                                        ...
                                        <div class="card-footer">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <?php if ($getOneBanner['imges_blogs'] != "http://public.rastasalamat.test/no_photo.png") { ?>
