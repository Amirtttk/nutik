<?php
$getOneComment = getOneComment(GET('id'));
?>
    <!--begin::Content-->
        ...
        <div class="subheader py-2 py-lg-4  subheader-solid " id="kt_subheader">
            <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-2">
                    ...
                    <!--begin::Page Title-->
                    <h5 class="card-label">ثبت پاسخ  </h5>
                    ...
                    <div class="card card-custom">
                        <div class="card-header">
                            <div class="card-title">
                                ...
                                <h3 class="card-label">ثبت پاسخ</h3>
                            </div>
                                            ...
                                            <div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        ...
                                                        <textarea name="text_admin" class="summernote" id="productDescription" rows="10">
                                                                <?= $getOneComment['text_admin'] ?>
                                                            </textarea>
                                                    </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <button type="button" class="btn btn-success mr-2"
                                                                onclick="updateComment(<?= $getOneComment['id']?>)">ویرایش</button>
